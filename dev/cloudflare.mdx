...
**Source code:** `stencil-themes/rustoleum-home/cloudflare-worker/paintcare-fee-worker.js`
...
The worker lives in `stencil-themes/rustoleum-home/cloudflare-worker/` with three files:
...
```bash
cd stencil-themes/rustoleum-home/cloudflare-worker
npx wrangler secret put BC_STORE_HASH
npx wrangler secret put BC_ACCESS_TOKEN
npx wrangler secret put PAINTCARE_FEE_SOURCE_URL
```
